...
Files named `issue-*.md` were copied from Agentic Project Template `0.5.0` as historical validation
and upgrade provenance for the reusable engineering harness. Their Issue, pull request, Project,
repository, and present-tense status references belong to the upstream template program or its
dogfood targets—not to Agentic Application Assessor.
